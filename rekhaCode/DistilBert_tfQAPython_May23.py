...
DATA_PATH = '/data/global_data/rekha_data/simplified-nq-train_100.jsonl'
EVAL_DATA_PATH = '/data/global_data/rekha_data/simplified-nq-valid_10.jsonl'
...
output_model_file = 'distil_bert_pytorch.bin'
